export const MentionLegale = () => {
  return (
    <div className='text-black bg-white py-8 px-4'>
      <h1>Conditions générales d'utilisation</h1>
      <p>En vigueur au 23/10/2023 </p>
      <p>
        ...
        du site et des services par _______________ et de définir les conditions
      ...
      <p>
        ...
        services proposés par le site. geekops.com se réserve le droit de
        modifier unilatéralement et à tout moment le contenu des présentes CGU.
      </p>
      <h2>Article 1 : Les mentions légales</h2>{" "}
      <p>
        L’édition et la direction de la publication du site geekops.com est
        assurée par ***********, domicilié ***********.
      </p>
      <p> Numéro de téléphone est ***********</p>{" "}
      <p>Adresse e-mail ***********.</p>{" "}
      <p>
        L'hébergeur du site geekops.com est la société ***********, dont le
        siège social est situé au ***********, avec le numéro de téléphone :
        ***********.
      </p>
      <h2>ARTICLE 2 : Accès au site</h2>{" "}
      <p>
        Le site geekops.com permet à l'Utilisateur un accès gratuit aux services
        suivants : Le site internet propose les services suivants : SPORT Le
      ...
      <p>
        ...
        communiqués après son inscription. Tout Utilisateur membre régulièrement
        inscrit pourra également solliciter sa désinscription en se rendant à la
        page dédiée sur son espace personnel. Celle-ci sera effective dans un
        délai raisonnable. Tout événement dû à un cas de force majeure ayant
        pour conséquence un dysfonctionnement du site ou serveur et sous réserve
        de toute interruption ou modification en cas de maintenance, n'engage
        pas la responsabilité de geekops.com. Dans ces cas, l’Utilisateur
        accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou
      ...
      <p>
        ...
        exerce ce droit : · par mail à l'adresse email *********** · via un
        formulaire de contact ; · via son espace personnel.
      </p>{" "}
      ...
      <p>
        Les sources des informations diffusées sur le site geekops.com sont
      ...
      <p>
        ...
        le site geekops.com ne peut être tenu responsable de la modification des
      ...
      <p>
        Le site geekops.com ne peut être tenu pour responsable d’éventuels virus
      ...
      <p>
        ...
        geekops.com. Ce dernier n’a pas de contrôle sur les pages web sur
      ...
      <p>
        ...
        nécessaires à l’utilisation du site geekops.com. Les cookies ne
      ...
      <p>
        En naviguant sur le site, L’Utilisateur les accepte. L’Utilisateur doit
        toutefois donner son consentement quant à l’utilisation de certains
        cookies. A défaut d’acceptation, l’Utilisateur est informé que certaines
      ...
      <p>
        Le site permet aux membres de publier les contenus suivants : wods de
        sport.
      </p>{" "}
      <p>
