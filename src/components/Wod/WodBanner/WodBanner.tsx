...
const WodBanner = ({ title, desc }: { title: string; desc: string }) => {
  return (
    <div className='home-ban flex flex-col justify-center items-center bg-cover bg-center text-white text-center bg-[url("../../public/_f5b62787-7c12-442f-915d-36c164d9f892.jpg")] py-24'>
